    ...
    <>
      <section className="min-h-[572px] relative">
        <div className="w-[60%] ml-24 mt-20 flex flex-col justify-center items-center">
          <h2 className="font-bold text-[60px] mb-5 w-full">
            OLÁ, EU SOU VILSON PADILHA
          </h2>
          <p className="text-[24px] w-full font-['monospace']">
          ...
          <button className="text-[24px] bg-blueBaby-300 w-fit px-5 py-[1.37rem] mt-10 mb-12 rounded-md font-['monospace']">
